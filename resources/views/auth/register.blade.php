                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-blue focus:ring focus:ring-brand-blue focus:ring-opacity-50 @if($errors->has('name')) border-brand-red @endif">
                            @if ($errors->has('name'))
                                <p class="mt-1 text-sm text-brand-red">{{ $errors->first('name') }}</p>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="password-confirm" type="password" name="password_confirmation" required
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-blue focus:ring focus:ring-brand-blue focus:ring-opacity-50">
                        </div>
